  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "editorial": "color-mix(in srgb, var(--editorial) calc(<alpha-value> * 100%), transparent)",
        "reading-warm": "color-mix(in srgb, var(--reading-warm) calc(<alpha-value> * 100%), transparent)",
        "reading-surface": "color-mix(in srgb, var(--reading-surface) calc(<alpha-value> * 100%), transparent)",
        "reading-raised": "color-mix(in srgb, var(--reading-raised) calc(<alpha-value> * 100%), transparent)",
        "reading-raised-hover": "color-mix(in srgb, var(--reading-raised-hover) calc(<alpha-value> * 100%), transparent)",
        "reading-note": "color-mix(in srgb, var(--reading-note) calc(<alpha-value> * 100%), transparent)",
        "reading-note-border": "color-mix(in srgb, var(--reading-note-border) calc(<alpha-value> * 100%), transparent)",
        "reading-note-ink": "color-mix(in srgb, var(--reading-note-ink) calc(<alpha-value> * 100%), transparent)",
        "reading-warn": "color-mix(in srgb, var(--reading-warn) calc(<alpha-value> * 100%), transparent)",
        "reading-warn-ink": "color-mix(in srgb, var(--reading-warn-ink) calc(<alpha-value> * 100%), transparent)",
        "reading-rail": "color-mix(in srgb, var(--reading-rail) calc(<alpha-value> * 100%), transparent)",
        "reading-rail-border": "color-mix(in srgb, var(--reading-rail-border) calc(<alpha-value> * 100%), transparent)",
        "reading-mode-ink": "color-mix(in srgb, var(--reading-mode-ink) calc(<alpha-value> * 100%), transparent)",
        "reading-mode-ink-hover": "color-mix(in srgb, var(--reading-mode-ink-hover) calc(<alpha-value> * 100%), transparent)",
        "reading-mode-on-accent": "color-mix(in srgb, var(--reading-mode-on-accent) calc(<alpha-value> * 100%), transparent)",
        "reading-pager": "color-mix(in srgb, var(--reading-pager) calc(<alpha-value> * 100%), transparent)",
        "reading-pager-ink": "color-mix(in srgb, var(--reading-pager-ink) calc(<alpha-value> * 100%), transparent)",
        "reading-pager-ink-hover": "color-mix(in srgb, var(--reading-pager-ink-hover) calc(<alpha-value> * 100%), transparent)",
        "reading-folio": "color-mix(in srgb, var(--reading-folio) calc(<alpha-value> * 100%), transparent)",
        "reading-folio-label": "color-mix(in srgb, var(--reading-folio-label) calc(<alpha-value> * 100%), transparent)",
        "reading-folio-dim": "color-mix(in srgb, var(--reading-folio-dim) calc(<alpha-value> * 100%), transparent)",
        "pill-surface": "color-mix(in srgb, var(--pill-surface) calc(<alpha-value> * 100%), transparent)",
        "pill-surface-hover": "color-mix(in srgb, var(--pill-surface-hover) calc(<alpha-value> * 100%), transparent)",
        "pill-ink": "color-mix(in srgb, var(--pill-ink) calc(<alpha-value> * 100%), transparent)",
      },
      borderRadius: {
        lg: "var(--radius)",
