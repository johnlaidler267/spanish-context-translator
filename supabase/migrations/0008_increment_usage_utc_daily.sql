-- =============================================================================
-- Migration: 0008_increment_usage_utc_daily
-- Description: Use explicit UTC day boundaries for texts_today/texts_today_date.
-- =============================================================================
...
comment on function public.increment_usage is
  'Increments usage counters; daily texts_today uses UTC calendar date only '
  '(now() AT TIME ZONE ''utc'')::date so API and DB agree.';
